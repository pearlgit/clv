...
//	$("#pageSlideCountIndi").html( emobj[23][3] );
	...
	function setNavTop(){
		...
		draggie.disable();
		$("#navMatterCont").addClass("onscroll");*/
	}
	function setNavMid(){
		$("html").addClass("noscroll");
	...
	draggie.on('dragMove', function(event,pointer,moveVector) {
		...
		if(openf == 0){
			...
			/*if (moveVector.y < 0){
				...
				draggie.disable();
				$("#navMatterCont").addClass("onscroll");
				$("#navMatterCont").animate({scrollTop: "50"}, 500);
			}*/
			if(dragpos < tbl){
				topClr();
			}
	...
	/*
	$("#navMatterCont").scroll(function(){
		console.log("scroll detected!!");
		if( $("#navMatterCont").scrollTop() == 0 ){
			console.log("top reached");
			draggie.enable();
			$("#navMatterCont").removeClass("onscroll");
		}
	});*/
